<fieldset class='form-group'>
    <input class='q21' id='q21-oui' name='Q21' type='radio' value='oui'><label for='oui'>&nbsp; Oui</label>
</fieldset>
<fieldset class='form-group'>
    <input id='q21-non' class='q21' name='Q21' type='radio' value='non'><label for='non'> &nbsp; Non</label> 
</fieldset>
