            ...
            <tbody>
                <tr>
                    <th scope="row">Déchets inertes</th>
                     <td><input name="percent" type = "number" maxlength = "9" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)"  id='q16-1-1'></td>
                    ...
                    <th scope="row">Déchets non dangereux non inertes</th>
                     <td><input name="percent" type = "number" maxlength = "9" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)"  id='q16-2-1'></td>
                    ...
                    <th scope="row">Déchets dangereux</th>
                     <td><input name="percent" type = "number" maxlength = "9" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)"  id='q16-3-1'></td>
