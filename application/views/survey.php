...
//            }
            ...
            if (id == 22)
            {
                ...
                if (answer != null && answer.indexOf(',') > -1) {
                    ...
                    $('input[value="' + answer + '"][name="Q22"]').prop('checked', true); // récupération de la réponse (radio)
                }
            ...
            if (id == 27)
            {
                ...
                if (answer != null && answer.indexOf(',') > -1) {
                    ...
                    $('input[value="' + answer + '"][name="Q27"]').prop('checked', true); // récupération de la réponse (radio)
                }
